 ...
 struct MACCommand_t
{
    ...
    /*!
    *  \brief  for all command bool state is the bit that indicate the command need to receive or to send
    *  1: send
    *  0: receive
    */
    ...
    */
    ...
    /*!
    *  \brief 0x02  LinkADRReq      0        1        Requests the end-device to change data rate, transmit power, repetition rate or channel.
	  *	 \param [IN] state  1: send  0: receive
...
extern const  struct MACCommand_t MACCommand;