...
if(a==8)b=i;
			...
			if(offset_store>=9400)
			{
				printf("read_from_port fun: if(offset_store>=940)\n");
				...
				printf("end_forwarding=%d offset_finish=%d  	offset_store=%d wait_packet=%d \n",end_forwarding,offset_finish,offset_store,wait_packet);
				int k;
